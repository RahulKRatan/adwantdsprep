package Bootcamp.Arrays.BitManipuation;
 ...
 * but it just falls short in dealing with the carry properly, but correctly adds when there is no need to deal with carry.
 * For Eg:
 *
 * 1   =>  001
 * 2   =>  010
